...
// //Menghapus Session respon jika telah di tampilkan
if (!empty($_SESSION['respon'])) {
...
?>
    ...
    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name"><?= $data['nama']; ?></div>
      <div class="profile-card__txt"><?= $data['descr']; ?></div>
      ...
      <div class="profile-card-social">
        <a href="<?= $data['fb_link'];?>" class="profile-card-social__item facebook" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-facebook"></use></svg>
          </span>
        </a>

        <a href="<?= $data['tw_link'];?>" class="profile-card-social__item twitter" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-twitter"></use></svg>
          </span>
        </a>

        <a href="<?= $data['ig_link'];?>" class="profile-card-social__item instagram" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-instagram"></use></svg>
          </span>
        </a>

        <a href="<?= $data['web_link'];?>" class="profile-card-social__item link" target="_blank">
          <span class="icon-font">
      ...
      <div class="profile-card-ctr">
        ...
        <?php if (isset($_SESSION['akses'])) {
          if ($_SESSION['akses'] > 0) {
            ?>
        <a style="text-decoration: none; color:white;" href="login.php"><button class="profile-card__button button--orange">Login</button></a>
            <?php
          }
        }
        ?>
